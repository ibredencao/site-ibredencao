...
- **Grid do site (todo o layout segue isso)**: 12 colunas, gutter de 40px (`gap-x-10`), sobre o container de conteúdo de 1585px (`max-w-[1585px] px-6 lg:px-10`, dentro do `Secao`). Colunas ≈95px (fluidas). Alinhar as seções a esse grid com `lg:grid-cols-12` + `lg:col-span-*`/`lg:col-start-*`. Ex.: em "Onde estamos" o texto é `col-span-3 col-start-3` e o mapa `col-span-5 col-start-6`.
